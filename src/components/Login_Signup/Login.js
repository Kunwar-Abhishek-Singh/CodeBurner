                            ...
                            <div className={classes.LOGIN_verification_main_div}>
                                ...
                                <div className={classes.userid_pwd_section}>
                                    <div className={classes.userId_pwd_div}>
                                        <input required className={classes.username_password_tag} type='text' placeholder=' User/Email id ' name='username' value={formValues.username} onChange={handleChange}></input>
                                    </div>
                                    <div className={classes.userId_pwd_div}>
